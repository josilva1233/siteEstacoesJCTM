    ...
    <head>
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                $sql = "SELECT * FROM ECQ001_21 WHERE dat_coleta BETWEEN '$dado' AND '$dado1' ORDER BY StampTime ASC;";
        ...
        <div class="container-sm" id="curve_chart">
            ...
            <div class="d-flex justify-content-center">
                <div class="spinner-border" role="status">
                    <span class="visually-hidden">Loading...</span> &ensp;
                </div>
                Não existe dados no periodo pesquisado ou Estacão sem receber dados
            </div>
        </div>
