...
<!-- Inicio da tabela em PHP-->
    ...
    $sql = "SELECT * FROM ECQ002_21 WHERE dat_coleta BETWEEN '$dado' AND '$dado1' ORDER BY StampTime ASC;";
    ...
    if ($buscar->num_rows > 0) {
        ...
        echo '<th width="5%">' . "NH3"   . '<sub>' . "(ppb)" . '</sub>' . '</th>';
        echo '<th width="5%">' . "H2S"   . '<sub>' . "(ppb)" . '</sub>' . '</th>';
        echo '</tr>';
        echo '</thead>';
    }else{
    ...
    while ($dados = mysqli_fetch_array($buscar)) {
        ...
        $NH3 = $dados['val_coleta13'];
        $H2S = $dados['val_coleta14'];
    ?>
