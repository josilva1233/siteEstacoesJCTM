    ...
    <body>
        ...
        <header class="container-fluid" id="estilo">
         ...
         echo ' </div>';
            ...
            echo 'href=';
            echo "'grafico1'";
            echo ' role="button" aria-expanded="false">Gráficos</a>';
          }
          ...
          ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-item" onclick="window.location.href='grafico8'">WS</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico9'">WD</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico10'">AT</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico11'">RH</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico12'">BP</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico13'">NH3</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico14'">H2S</li>
                        </ul>
