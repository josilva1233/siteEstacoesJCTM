...
<!-- Inicio da tabela em PHP-->
    ...
    $sql = "SELECT * FROM ECQ007_22 WHERE dat_coleta BETWEEN '$dado' AND '$dado1' ORDER BY StampTime ASC;";
    ...
    if ($buscar->num_rows > 0) {
        ...
        echo '<th width="5%">' . "NH3"   . '<sub>' . "(ppm)" . '</sub>' . '</th>';
        echo '<th width="5%">' . "H2S"   . '<sub>' . "(ppm)" . '</sub>' . '</th>';
        echo '</tr>';
        echo '</thead>';
    }else{
