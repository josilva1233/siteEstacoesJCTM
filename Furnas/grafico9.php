        ...
        $(document).ready(function() {
         ...
         function drawChart() {
             var data = google.visualization.arrayToDataTable([
                ...
                ?>['<?php echo $date; ?> <?php echo $hora; ?>', <?php echo $NMHC; ?>],

                 <?php  } ?>

             ]);
             //tamanho e configurações do grafico google charts
             var options = {
         ...
         <div class="container">
             <form class="navbar-form navbar-right" action="" method="get">
                 <div class="form-group">
                     ...
                     <input placeholder="Selecione data inicial:" autocomplete="off" name="datapesquisafinal"
