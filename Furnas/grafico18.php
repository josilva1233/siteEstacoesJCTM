        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                while ($dados = mysqli_fetch_array($buscar)) {
                    ...
                    $ex2= $dados['val_coleta18'];
       
                ?>
                ['<?php echo $date;?> <?php echo $hora;?>', <?php echo $ex2;?>],
            ...
            var options = {
                ...
                vAxis:{
                    title: 'Eixo: <?php echo "Y"; ?>',
                },

                hAxis: {

                    title: 'Eixo: <?php echo "X"; ?>',
    ...
    <body>
        ...
        <form class="navbar-form navbar-right" action="" method="get">
            <div class="form-group" >
                ...
                <input  placeholder="Selecione data inicial:" autocomplete="off" name="datapesquisafinal" id="datapesquisafinal" aria-hidden="false" class="datepicker" required>
        ...
        <div id="curve_chart" class="container-sm">
