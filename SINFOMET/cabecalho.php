    ...
    <body>
        ...
        <header class="container-fluid" id="estilo">
          ...
          if (!$_SESSION) {
            ...
            echo "(Modelo: ".$_SESSION['nome']." Serial:"." 001.08.21 )";
            //botão sair 
            echo '<br>';
         ...
         echo ' </div>';
          ...
          ?>
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item" onclick="window.location.href='grafico1'">BattV</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico2'">Temp</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico3'">PTS</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico4'">PM10</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico5'">PM2.5</li>
                            <li class="dropdown-item" onclick="window.location.href='grafico6'">PM1</li>
                        </ul>
